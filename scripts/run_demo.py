...
if __name__=="__main__":
  ...
  parser.add_argument('--left_file', default=f'{code_dir}/../images/0_left_undist.png', type=str)
  parser.add_argument('--right_file', default=f'{code_dir}/../images/0_right_undist.png', type=str)
  ...
  calib_path = ROOT / "DiplomaThesis_git/NICO/out/calib_data.npy"

  print(calib_path)

  calib_dict = load_dict("/mnt/c/Users/matej/Desktop/DiplomaThesis_git/NICO/out/calib_data.npy")
  calib_dict = load_dict(calib_path)
  ...
  if args.get_pc:
    ...
    #   lines = f.readlines()
    K = calib_dict['K_l'] #np.array(list(map(float, lines[0].rstrip().split()))).astype(np.float32).reshape(3,3)
